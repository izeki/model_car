...
def get_model(channel=3, meta_label=6, input_width=672, input_height=376, phase='train'):
    ...
    conv2 = SeparableConv2D(filters=256, kernel_size=3, strides=(2,2), padding='valid', activation='relu', depth_multiplier=2, data_format='channels_first', name='conv2')(conv1_metadata_concat)
